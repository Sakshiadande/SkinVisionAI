...
train_dataset = train_datagen.flow_from_directory(
    'D:\\MP\\Minor\\train',  # Replace with actual training dataset path
...
val_dataset = val_datagen.flow_from_directory(
    'D:\\MP\\Minor\\validation',  # Replace with actual validation dataset path
    target_size=image_size,
    batch_size=batch_size,
    class_mode='categorical'
)
...
def predict_image(img_array):
    ...
    class_names = ['Acne', 'Acne Scars', 'Pigmentation', 'Dark Circles', 'Open Pores']
